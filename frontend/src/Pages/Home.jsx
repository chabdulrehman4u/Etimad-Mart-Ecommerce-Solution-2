...
const SectionSkeleton = ({ className = '', height = 'h-40 md:h-60' }) => (
  <div className={`${height} ${className} bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 animate-pulse rounded-lg`}>
...
// Optimized Section Component with suspense loading
  ...
  return (
    <>
      <Helmet>
        ...
        {/* Preload critical backend API */}
        <link rel="preconnect" href="https://etimad-mart-api.onrender.com" />
      </Helmet>
      <h1 className="hidden">
